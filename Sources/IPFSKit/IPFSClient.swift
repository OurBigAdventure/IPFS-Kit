...
public class IPFSClient: IPFSBase {
  ...
  /// - Parameters:
  ///   - showOptions: (Bool) Should options be returned for commands?
  ///   - completionHandler: (JsonType) -> Void to handle the returned (JSON formatted) list of commands
  public func commands(_ showOptions: Bool = false,
                       completionHandler: @escaping (JsonType) -> Void) throws {
    var request = "commands"
  ...
  /// - Parameters:
  ///   - updateHandler: (Data) throws -> Bool to process updates and decide if logging should continue
  ///   - completionHandler: ([[String : AnyObject]]) -> Void  to handle the log completion
...
extension IPFSBase {
  ...
  /// - Parameter completionHandler: ([Multiaddr])->Void to allow you to process the returned peers
...
extension IPFSBase {
  /// Downloads and installs updates for IPFS.  This is not implemented here because it
  /// is disabled in the API, method stub can remain for future implementation.
  /// - Parameter completionHandler: ([String: AnyObject])->Void to allow you to handle returned dictionary
...
/// - Parameter rawJson: (Data) raw JSON data
/// - Returns: (Data) fixed JSON data
...
/// Build an arguement string from an array
/// - Parameter args: ([String]) array of arguements
/// - Returns: (String) querystring of arguements
